...
export const signup = async obj => {
  ...
  .then(data => {
    ...
    if (data.status === 'success') {
      ...
      showAlert('error', 'Nie udało Ci się zarejestrować - Hasła są różne lub użytkownik o takim adresie email już istnieje');
  })
...
export const changePhoto = async obj => {
  ...
  .then(data => {
    if (data.status === 'success')
      ...
      showAlert('error', 'Nie udało się zmienić zdjęcia profilowego');
  })
  .catch(error => console.log(error));
}
...
export const resetPassword = async (obj, token) => {
  ...
  .then(data => {
    ...
    if (data.status === 'success') {
      ...
      showAlert('error', 'Nie udało się zresetować hasła. Sprawdź, czy hasła są identyczne!');
  })
  .catch(error => console.log(error));
}
...
export const changeMyAddress = async obj => {
  ...
  .then(data => {
    if (data.status === 'success')
      ...
      showAlert('error', 'Nie udało się zmienić adresu');
  })
  .catch(error => console.log(error));
}
...
export const changeEmail = async obj => {
  ...
  .then(data => {
    if (data.status === 'success')
      ...
      showAlert('error', 'Nie udało się zmienić adresu email');
  })
  .catch(error => console.log(error));
}
...
export const changePhone = async obj => {
  ...
  .then(data => {
    if (data.status === 'success')
      ...
      showAlert('error', 'Nie udało się wprowadzić zmian');
  })
  .catch(error => console.log(error));
}
...
export const deleteMe = async () => {
  ...
  .then(data => {
    if (data.status === 'success')
      ...
      showAlert('error', 'Nie udało się usunąć konta');
  })
  .catch(error => console.log(error));
}
...
export const changeStatus = async id => {
  ...
  .then(data => {
    if (data.status === 'success')
      ...
      showAlert('error', 'Nie udało się zmienić statusu konta');
  })
  .catch(error => console.log(error));
}
